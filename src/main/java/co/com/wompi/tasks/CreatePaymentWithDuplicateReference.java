...
public class CreatePaymentWithDuplicateReference implements Task {
    @Step("Intenta una transaccion con una referencia duplicada")
    @Override
    public <T extends Actor> void performAs(T actor) {
        ...
        payment.reference = "REF-WOMPI-001"; // misma referencia que la exitosa
    ...
    public static CreatePaymentWithDuplicateReference transaction() {
        return Tasks.instrumented(CreatePaymentWithDuplicateReference.class);
    }
}
